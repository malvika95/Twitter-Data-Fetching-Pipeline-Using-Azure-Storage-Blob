...
from ..service.resources import azure_messaging_config as conf
...
class TweetLoader:
    ...
    def load_params(self, config_file, search_query,request_id):
        ...
        while total_results < self.num_results:
            ...
            try:
                ...
                if "data" not in r.json().keys():
                    self.message_list = "No results obtained for given search parameter"
                    return self.message_list
...
#     tweet_object.load_auth_details('app\\main\\service\\resources\\keys.json')
#     tweet_object.load_params('app\\main\\service\\resources\\config.json')
